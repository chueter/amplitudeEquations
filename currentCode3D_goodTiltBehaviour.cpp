...
#define NZ 8  // number of grid points in z direction
	...
	for (i=1; i<NX-1; ++i)
    {
	  for (j=1; j<NY-1; ++j)
	  {
		for (k=1; k<NZ-1; ++k)
        {
			...
			phi_ccp = h((A011[i][j][k+1]*conj(A011[i][j][k+1]) +  A101[i][j][k+1]*conj(A101[i][j][k+1]) + A110[i][j][k+1]*conj(A110[i][j][k+1]) +  A01m1[i][j][k+1]*conj(A01m1[i][j][k+1]) +  A10m1[i][j][k+1]*conj(A10m1[i][j][k+1]) + A1m10[i][j][k+1]*conj(A1m10[i][j][k+1]) )/6.);
			...
			/*
			phi_ccc = ( h( A011[i][j][k]*conj(A011[i][j][k])) +  h(A101[i][j][k]*conj(A101[i][j][k])) + h(A110[i][j][k]*conj(A110[i][j][k])) +  h(A01m1[i][j][k]*conj(A01m1[i][j][k])) +  h(A10m1[i][j][k]*conj(A10m1[i][j][k])) + h(A1m10[i][j][k]*conj(A1m10[i][j][k]) ) )/6. ;
			phi_pcc = ( h(A011[i+1][j][k]*conj(A011[i+1][j][k])) +  h(A101[i+1][j][k]*conj(A101[i+1][j][k])) + h(A110[i+1][j][k]*conj(A110[i+1][j][k])) +  h(A01m1[i+1][j][k]*conj(A01m1[i+1][j][k])) +  h(A10m1[i+1][j][k]*conj(A10m1[i+1][j][k])) + h(A1m10[i+1][j][k]*conj(A1m10[i+1][j][k]) ) )/6.;
			phi_mcc = ( h(A011[i-1][j][k]*conj(A011[i-1][j][k])) +  h(A101[i-1][j][k]*conj(A101[i-1][j][k])) + h(A110[i-1][j][k]*conj(A110[i-1][j][k])) +  h(A01m1[i-1][j][k]*conj(A01m1[i-1][j][k])) +  h(A10m1[i-1][j][k]*conj(A10m1[i-1][j][k])) + h(A1m10[i-1][j][k]*conj(A1m10[i-1][j][k]) ) )/6.;
			phi_cpc = ( h(A011[i][j+1][k]*conj(A011[i][j+1][k])) +  h(A101[i][j+1][k]*conj(A101[i][j+1][k])) + h(A110[i][j+1][k]*conj(A110[i][j+1][k])) +  h(A01m1[i][j+1][k]*conj(A01m1[i][j+1][k])) +  h(A10m1[i][j+1][k]*conj(A10m1[i][j+1][k])) + h(A1m10[i][j+1][k]*conj(A1m10[i][j+1][k]) ) )/6.;
			phi_cmc = ( h(A011[i][j-1][k]*conj(A011[i][j-1][k])) +  h(A101[i][j-1][k]*conj(A101[i][j-1][k])) + h(A110[i][j-1][k]*conj(A110[i][j-1][k])) +  h(A01m1[i][j-1][k]*conj(A01m1[i][j-1][k])) +  h(A10m1[i][j-1][k]*conj(A10m1[i][j-1][k])) + h(A1m10[i][j-1][k]*conj(A1m10[i][j-1][k]) ) )/6.;
			phi_ccp = ( h(A011[i][j][k+1]*conj(A011[i][j][k+1])) +  h(A101[i][j][k+1]*conj(A101[i][j][k+1])) + h(A110[i][j][k+1]*conj(A110[i][j][k+1])) +  h(A01m1[i][j][k+1]*conj(A01m1[i][j][k+1])) +  h(A10m1[i][j][k+1]*conj(A10m1[i][j][k+1])) + h(A1m10[i][j][k+1]*conj(A1m10[i][j][k+1]) ) )/6.;
			phi_ccm = ( h(A011[i][j][k-1]*conj(A011[i][j][k-1])) +  h(A101[i][j][k-1]*conj(A101[i][j][k-1])) + h(A110[i][j][k-1]*conj(A110[i][j][k-1])) +  h(A01m1[i][j][k-1]*conj(A01m1[i][j][k-1])) +  h(A10m1[i][j][k-1]*conj(A10m1[i][j][k-1])) + h(A1m10[i][j][k-1]*conj(A1m10[i][j][k-1]) ) )/6.;
			*/
			/*
			...
			*/
			...
			mu_k_ccc = mu_k_atR(A011, A101, A110, A01m1, A10m1, A1m10, conc,  ALPHA, i,  j,  k);
			mu_k_pcc = mu_k_atR(A011, A101, A110, A01m1, A10m1, A1m10, conc,  ALPHA, i+1,  j,  k);
			mu_k_mcc = mu_k_atR(A011, A101, A110, A01m1, A10m1, A1m10, conc,  ALPHA, i-1,  j,  k);
			mu_k_cpc = mu_k_atR(A011, A101, A110, A01m1, A10m1, A1m10, conc,  ALPHA, i,  j+1,  k);
			mu_k_cmc = mu_k_atR(A011, A101, A110, A01m1, A10m1, A1m10, conc,  ALPHA, i,  j-1,  k);
			mu_k_ccp = mu_k_atR(A011, A101, A110, A01m1, A10m1, A1m10, conc,  ALPHA, i,  j,  k+1);
			mu_k_ccm = mu_k_atR(A011, A101, A110, A01m1, A10m1, A1m10, conc,  ALPHA, i,  j,  k-1);
